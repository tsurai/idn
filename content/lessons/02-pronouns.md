...
#### Second person
<dl class="card grid4">
{{ vocab(id="anda", en="you", pos="pronon", details="formal") }}
{{ vocab(id="kamu", en="you", pos="pronoun", details="casual") }}
{{ vocab(id="lu", en="you", pos="pronoun", details="slang") }}
{{ vocab(id="kalian", en="you all", pos="pronoun", details="plural") }}
{{ vocab(id="tahu", en="to know", pos="verb") }}
</dl>
...
#### Third person
<dl class="card grid2">
{{ vocab(id="Ia", en="He / She", pos="pronoun", details="formal, gender-neutral") }}
{{ vocab(id="Dia", en="He / She", pos="pronoun", details="casual, gender-neutral") }}
{{ vocab(id="Beliau", en="He / She", pos="pronoun", details="very formal, gender-neutral") }}
{{ vocab(id="Mereka", en="They", pos="pronoun", details="plural, gender-neutral") }}
</dl>
...
{{ vocab(id="Kucing hitammu", en="Your black cat", pos="nount+ adjective + pronoun suffix", details="noun phrase", verbose=[
...
<dl class="card grid3">
{{ vocab(id="ini", en="this / these", pos="demonstrative") }}
{{ vocab(id="itu", en="that / those", pos="demonstrative") }}
{{ vocab(id="adalah", en="to be / is / are", pos="verb") }}
</dl>
...
Take note how the position of {{id(id="ini", en="this")}} or {{id(id="itu", en="that")}} within a sentence influences the _noun phrase_ being modified. In this case, **This is a [cute black cat]** vs **[This black cat] is cute**. This has further grammatical implications depending on the context this form is used in. While {{id(id="Ini kucing hitam saya", en="This is my black cat")}} / **This is my black cat** is a grammatically correct sentence, {{id(id="Kucing hitam ini saya")}} is wrong and makes no sense.

The reason for this is that both {{id(id="ini", en="this")}} and {{id(id="saya", en="I")}} compete as a _modifier_ for the _noun phrase_ {{id(id="kucing hitam")}}. But in _Indonesian_ the _demonstrative determiner_, meaning {{id(id="ini", en="this")}} or {{id(id="itu", en="that")}} at the end of a _noun phrase_, structurally _completes_ it. The _noun phrase_ cannot be further modified afterward and thus {{id(id="saya", en="I")}} can no longer function as a _possessive pronoun_. Additional meaning can still be added with a predicate forming a new, separate _phrase_ like for example, {{id(id="Kucing hitam ini besar dan luca", en="This black cat is big and cute")}} / **[This black cat] is [big and cute]**. 

##### Examples
<dl class="card">
{{ vocab(id="Kucing hitam saya ini lucu", en="This black cat of mine is cute", pos="noun + adjective + pronoun + demonstrative determiner + adjective", verbose=[
  [["Kucing","n"], ["hitam", "adj"], ["saya", "posp"], ["ini", "demd"], "S"], [["lucu", "adj"], "P"]
]) }}
{{ vocab(id="Itu kucing-kucing putih aku", en="Those are my white cats", pos="demonstrative pronoun + noun + adjective + possessive pronoun", verbose=[
  [["Itu","demp"], "S"], [["kucing-kucing", "n"], ["putih", "adj"], ["aku", "posp"], "P"]
]) }}
{{ vocab(id="Kucing ini milik dia", en="This cat belongs to him/her", pos="noun + demonstrative determiner + verb + pronun", verbose=[
  [["Kucing", "n"], ["init", "demd"], "S"], ["milik", "v"], [["dia", "perp"], "P"]
]) }}
{{ vocab(id="Ini adalah buku saya", en="This is my book", details="formal & explicit", pos="demonstrative pronoun + verb + noun + possessive pronoun", verbose=[
  [["Ini", "demp"], "S"], ["adalah", "v"], [["buku", "n"], ["saya", "posp"], "P"]
]) }}
</dl>
